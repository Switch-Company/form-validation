 ...
 * @license ISC
 **/
!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof define&&define.amd?define(t):e.formValidation=t()}(this,function(){"use strict";var e=new Map;function t(e,t,i){var n={bubbles:!0,cancelable:!1};i&&(n.detail=i);var a=new window.CustomEvent(t,n);e.dispatchEvent(a)}var i=function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")},n=function(){function e(e,t){for(var i=0;i<t.length;i++){var n=t[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,i,n){return i&&e(t.prototype,i),n&&e(t,n),t}}(),a=function e(t,i,n){null===t&&(t=Function.prototype);var a=Object.getOwnPropertyDescriptor(t,i);if(void 0===a){var r=Object.getPrototypeOf(t);return null===r?void 0:e(r,i,n)}if("value"in a)return a.value;var l=a.get;return void 0!==l?l.call(n):void 0},r=function(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t},l=function(){function a(n){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};i(this,a),this.el=n,this.el.validator=this,this._invalid=[],this._customRules=r.customRules||[],this._fieldValidation=function(i,n,a){var r=i.validity.valid,l=e.has(i.name),o={context:n,validityState:"valid",wasInvalid:l};if(!r){var s=[];for(var u in i.validity)i.validity[u]&&s.push(u);if(s.includes("customError")){var c=e.get(i.name);l&&c!==i.value?(r=!0,i.setCustomValidity("")):(o.message=i.validationMessage,o.validityState="customError")}else o.validityState=s[0]}return a&&r&&!i.disabled&&(i.required||i.value.length>0)&&a.every(function(e){if(i.matches(e.match)){var t=e.test(i);return!(!t||"string"==typeof t)||(o.validityState=t||"customError",e.message&&(i.setCustomValidity(e.message),o.message=e.message),!1)}return!0}),"valid"===o.validityState?(e.delete(i.name),t(i,"valid",o)):(e.set(i.name,i.value),o.message||(o.message=""),t(i,"invalid",o)),"valid"===o.validityState}.bind(this)}return n(a,[{key:"_checkSingleValidity",value:function(e,t){var i=this._fieldValidation(e,t,this._customRules),n=this._invalid.indexOf(e);return i||-1!==n?i&&n>-1&&this._invalid.splice(n,1):this._invalid.push(e),i}},{key:"checkValidity",value:function(){var e=this,t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:this.el;return t.elements||"FIELDSET"===t.nodeName?(this._invalid.length=0,Array.from(t.elements||t.querySelectorAll("input, textarea, select")).forEach(function(i){i.willValidate&&"submit"!==i.type&&e._checkSingleValidity(i,t)}),0===this._invalid.length):this._checkSingleValidity(t,t)}},{key:"invalid",get:function(){return this._invalid}}]),a}();return function(e){function t(){return i(this,t),r(this,(t.__proto__||Object.getPrototypeOf(t)).apply(this,arguments))}return function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}(t,l),n(t,[{key:"_checkSingleValidity",value:function(e,i){var n=a(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),"_checkSingleValidity",this).call(this,e,i),r=e.closest("fieldset");if(!r)return n;var l=this.fieldset(r),o=l._invalid.indexOf(e);return n||-1!==o?n&&o>-1&&l._invalid.splice(o,1):l._invalid.push(e),n}},{key:"checkValidity",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:this.el;if("FIELDSET"!==e.nodeName)return a(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),"checkValidity",this).call(this,e);var i=this.fieldsets.find(function(t){return t.el==e});return i?i.checkValidity():void 0}},{key:"fieldset",value:function(e){if(this.el.contains(e))return e.validator||new l(e,{customRules:this._customRules})}},{key:"setValidity",value:function(){var e=this,t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};Array.from(this.el.elements).forEach(function(i){if(i.willValidate&&"submit"!==i.type){var n=i.validationMessage,a=t[i.name]||"";i.setCustomValidity(a),n!==a&&e._checkSingleValidity(i,e.el)}})}},{key:"fieldsets",get:function(){var e=this;return Array.from(this.el.querySelectorAll("fieldset")).map(function(t){return t.validator||new l(t,{customRules:e._customRules})})}}]),t}()});
